			...
			<div class="col-md-8 reg_bg mar_t50">
				...
				<form action ="" method = "post" enctype="multipart/form-data" id="regform">
					...
					<div class=" custom-file">
						<input type="file" class="form-control custom-file-input" name="fileToUpload" id="fileToUpload" /><a style="display:none;" id="removeImage" href="#">Remove</a><br><span id="imageerror" class="error">
...
function validation() {
	...
	$('[id^=skillname]').each(function() {
		var getid = this.id;
		intid = getid.replace(/[A-Za-z$-]/g, ""); //returns only integer 
